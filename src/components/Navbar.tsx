      ...
      <div className="bg-[#0F172A] dark:bg-[#060911] text-gray-300 text-xs py-1.5 px-4 sm:px-6 lg:px-8 border-b border-gray-800 dark:border-gray-900 hidden sm:block">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Quick Utility Tools Links */}
            <div className="flex items-center gap-3 text-[11px]">
              <button
                onClick={onOpenMediaGuide}
                className="text-gray-400 hover:text-[#00B4D8] transition-colors flex items-center gap-1 font-medium cursor-pointer"
              >
                <Play className="w-3 h-3 text-[#00B4D8]" />
                <span>Muestras & Demos</span>
              </button>
